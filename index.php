...
<section class="py-24 flex flex-col items-center text-center">
    <div class="max-w-4xl px-6">
        <div class="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-indigo-500/10 border border-indigo-500/20 text-indigo-600 dark:text-indigo-400 text-xs font-bold uppercase tracking-widest mb-8 animate-bounce">
        ...
        <h1 class="text-6xl md:text-8xl font-extrabold tracking-tight mb-8 bg-gradient-to-r from-primary via-indigo-400 to-purple-500 bg-clip-text text-transparent leading-tight">
        ...
        <p class="text-xl md:text-2xl text-slate-500 dark:text-slate-400 mb-12 max-w-2xl mx-auto leading-relaxed">
            The modern financial operating system for high-performers. Precision tracking, intelligent insights, and elegant design.
        </p>
        
        <div class="flex flex-col sm:flex-row gap-6 justify-center mb-20">
            <a href="register.php" class="bg-primary hover:bg-secondary text-white px-10 py-5 rounded-2xl text-xl font-bold shadow-2xl shadow-indigo-500/20 transition-all hover:scale-105 active:scale-95 flex items-center gap-2">
                Get Started Free <i class="bi bi-arrow-right"></i>
            </a>
            <a href="login.php" class="glass px-10 py-5 rounded-2xl text-xl font-bold transition-all hover:bg-white/10 flex items-center gap-2">
                Sign In
            </a>
        </div>
        ...
        <div class="relative group max-w-5xl mx-auto">
            <div class="absolute -inset-1 bg-gradient-to-r from-primary to-purple-600 rounded-[2.5rem] blur opacity-25 group-hover:opacity-50 transition duration-1000 group-hover:duration-200"></div>
            <div class="relative glass rounded-[2.5rem] overflow-hidden border border-white/10 shadow-2xl">
                <img src="assets/dashboard_mockup_preview.png" alt="Dashboard Preview" class="w-full h-auto transform transition duration-500 group-hover:scale-[1.02]">
            </div>
        </div>
    </div>
</section>
